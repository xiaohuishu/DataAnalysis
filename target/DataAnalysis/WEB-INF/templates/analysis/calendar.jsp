...
<html>
    ...
    <head>
        ...
        <link href="<%=request.getContextPath()%>/styles/vendors/fullcalendar/fullcalendar.css" rel="stylesheet" media="screen">
    ...
    <body>
        ...
        <script src="<%=request.getContextPath()%>/styles/vendors/jquery-ui-1.10.3.js"></script>
        <script src="<%=request.getContextPath()%>/styles/bootstrap/js/bootstrap.min.js"></script>
        <script src="<%=request.getContextPath()%>/styles/vendors/fullcalendar/fullcalendar.js"></script>
        <script src="<%=request.getContextPath()%>/styles/vendors/fullcalendar/gcal.js"></script>
