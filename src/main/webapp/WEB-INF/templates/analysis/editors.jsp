...
<html>
    ...
    <body>
        ...
        <!--/.fluid-container-->
        <script src="<%=request.getContextPath()%>/styles/vendors/bootstrap-wysihtml5/lib/js/wysihtml5-0.3.0.js"></script>
		...
		<script src="<%=request.getContextPath()%>/styles/vendors/bootstrap-wysihtml5/src/bootstrap-wysihtml5.js"></script>

		<script src="<%=request.getContextPath()%>/styles/vendors/ckeditor/ckeditor.js"></script>
		<script src="<%=request.getContextPath()%>/styles/vendors/ckeditor/adapters/jquery.js"></script>

		<script type="text/javascript" src="<%=request.getContextPath()%>/styles/vendors/tinymce/js/tinymce/tinymce.min.js"></script>
