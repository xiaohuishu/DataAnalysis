if (wysihtml5.browser.supported()) {
  ...
  asyncTest("Check placeholder", function() {
    ...
    editor.observe("load", function() {
      ...
      ok(wysihtml5.dom.hasClass(composerElement, "placeholder"), "Editor got 'placeholder' css.css class");
      ...
      ok(!wysihtml5.dom.hasClass(composerElement, "placeholder"), "Editor hasn't got 'placeholder' css.css class");
